    ...
    <div x-data="{
        ...
        <div class="w-full bg-black md:pt-20 pt-5 px-5">
            <div class="mx-5 flex md:justify-between">
                <div>
                    <h1 class="text-2xl md:text-4xl text-white">Sneakers</h1>
                </div>
                ...
                <div class="hidden md:block">
                    <h1 class="text-2xl md:text-4xl text-white -scale-x-100 traced-white">Sneakers</h1>
                </div>
            </div>
                            ...
                            <div class="mx-4 mt-8 py-1 sm:py-6">
                                <div id="slide-container" class="flex overflow-hidden">
                                    ...
                                    @foreach ($sneakersNike as $sneaker)
                                        <div class="slide-item flex-shrink-0 w-1/1 md:w-1/4 mr-3 md:mr-2">
                                            <div
