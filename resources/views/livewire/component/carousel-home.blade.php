<div>
    <div class="relative bg-black" x-data="{
        ...
        <div class="absolute z-30 flex space-x-3 -translate-x-1/2 bottom-5 left-1/2">
            <button type="button" x-on:click="currentSlide = 1" :class="{ 'bg-black': currentSlide == 1, 'bg-white': currentSlide != 1 }" class="w-5 h-2 rounded-full bg-black" aria-current="true" aria-label="Slide 1" data-carousel-slide-to="0"></button>
            <button type="button" x-on:click="currentSlide = 2" :class="{ 'bg-black': currentSlide == 2, 'bg-white': currentSlide != 2 }" class="w-5 h-2 rounded-full" aria-current="false" aria-label="Slide 2" data-carousel-slide-to="1"></button>
            <button type="button" x-on:click="currentSlide = 3" :class="{ 'bg-black': currentSlide == 3, 'bg-white': currentSlide != 3 }" class="w-5 h-2 rounded-full" aria-current="false" aria-label="Slide 3" data-carousel-slide-to="2"></button>
        </div>
