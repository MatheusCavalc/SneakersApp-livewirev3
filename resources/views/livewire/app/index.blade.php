    ...
    <div class="mt-2">
        <div>
            <div class="w-full bg-black py-5 px-5">
                <div class="flex">
                    <div>
                        <h1 class="ml-5 text-4xl text-white">Nike</h1>
                    </div>
                            ...
                            <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-6 lg:max-w-7xl lg:px-8">
                                <div class="mt-2 md:flex md:justify-around">
                                    ...
                                    @foreach ($sneakersNike as $sneaker)
                                        <div
                                            class="relative my-3 mx-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
                                            ...
                                            <div class="mt-4 px-5 pb-5">
                                                ...
                                                <a href="#"
                                                    class="flex items-center justify-center rounded-md bg-black px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-blue-300">
        ...
        <div>
            <div class="w-full bg-white py-5 px-5">
                <div class="flex">
                    <div>
                        <h1 class="ml-5 text-4xl text-black">Air Jordan</h1>
                    </div>

                    <div class="ml-5">
                        <hr class="w-64 h-1 my-8 bg-black border-0 rounded">
                    </div>
                </div>
        ...
        <div>
            <div class="w-full bg-black py-5 px-5">
                <<div class="flex">
                    <div>
                        <h1 class="ml-5 text-4xl text-white">Adidas</h1>
                    </div>
