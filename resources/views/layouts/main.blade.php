                ...
                <div :class="{ 'block': open, 'hidden': !open }"
                    ...
                    <div x-data="{ open: false, open2: false }">
                        <ul
                            ...
                            <!-- Menu with dropdowns -->
                            <li>
                                <button x-on:click="open = !open" id="dropdownNavbarLink"
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-200"
                                        ...
                                        class="absolute z-10 mt-2 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                    ...
                    <div class="mb-6 md:mb-0">
                        <a href="https://flowbite.com/" class="flex items-center">
                            <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3"
                                alt="FlowBite Logo" />
                            <span
                                class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">SB</span>
                        </a>
                    </div>
