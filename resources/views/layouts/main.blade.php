        ...
        <nav x-data="{ openNavbar: false, openSearchBar: false }" class="bg-white border-gray-200 dark:bg-gray-900">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="flex md:order-2">
                    ...
                    <button x-on:click="openNavbar = !openNavbar, openSearchBar = false"
                ...
                <div :class="{ 'block': openNavbar, 'hidden': !openNavbar }"
                    ...
                    <div x-data="{ open: false, open2: false }">
                        <ul
                            ...
                            <li>
                                <livewire:component.navbar.home-item />
                            </li>

                            <!-- Menu with dropdowns -->
                            <li>
                                <livewire:component.navbar.trendings-item />
                            </li>

                            <li>
                                <a href="/collections" wire:navigate
                                    class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Collections</a>
                            </li>
                            <li>
                                ...
                                <li>
                                    @auth
                                        @if (Auth::user()->name == 'Admin')
                                            <a href="/admin" class="hover:underline">{{ Auth::user()->name }}</a>
                                        @endif
                                    @endauth
                                </li>
                            </ul>
