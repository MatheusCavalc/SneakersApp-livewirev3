...
<body>
    <div x-data="{ open1: false }" :class="{ 'overflow-hidden': open1, '': !open1 }">
        <nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <div class="px-3 py-3 lg:px-5 lg:pl-3">
                <div class="flex items-center justify-between">
                    <div class="flex items-center justify-start">
                        <button x-on:click="open1 = !open1" data-drawer-target="logo-sidebar"
                        ...
                        <a href="/admin" wire:navigate class="flex ml-2 md:mr-24">
                            <img src="https://flowbite.com/docs/images/logo.svg" class="h-8 mr-3" alt="FlowBite Logo" />
                            <span
                                class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">SB</span>
                        </a>
                    </div>
                    <div class="flex items-center">
                        <div x-data="{ open: false }" class="flex items-center ml-3">
                            <div>
        ...
        <aside id="logo-sidebar" :class="{ 'transform-none': open1, '-translate-x-full': !open1 }"
            ...
            <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
                <ul class="space-y-2 font-medium">
                    <li>
                        <a href="/admin/brands" wire:navigate
                    ...
                    <li>
                        <a href="/admin/collections" wire:navigate
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <a href="/admin/sneakers" wire:navigate
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">Sneakers</span>
                            <!--<span
        ...
        <div x-show="open1" class="bg-gray-900 bg-opacity-50 dark:bg-opacity-80 fixed inset-0 z-30"></div>
    </div>
